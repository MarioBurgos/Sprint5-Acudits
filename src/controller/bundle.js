...
var JokesComponent = /** @class */ (function () {
    ...
    JokesComponent.prototype.show = function (data) {
        ...
        app.parentElement.parentElement.className = "card p-4 shadow-lg mx-auto mb-3 bg-" + i;
